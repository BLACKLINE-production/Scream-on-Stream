...
pub struct TikTokLiveConfig {
    ...
    /// Pre-fetched ttwid cookie value, bypassing the automatic anonymous
    /// fetch. Set via [`TikTokLiveBuilder::ttwid`]. Useful when TikTok's
    /// anti-bot WAF blocks the automatic fetch from this client.
    pub ttwid_override: Option<String>,
